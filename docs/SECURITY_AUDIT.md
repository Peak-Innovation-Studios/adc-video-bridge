...
- go2rtc's API/snapshot and RTSP endpoints require separate credentials. Compose refuses to start if any of the four is unset or empty. Unused WebRTC and SRTP listeners are disabled.
